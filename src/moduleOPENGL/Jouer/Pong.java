...
public class Pong extends Game implements SetRaquetteDecoGuiAffichage 
{
    // The textures
	...
	public void setRaquette(int choixRaquette) {
		...
		if (choixRaquette==1) variable = "src/ImagesGUI/raquetteSport";
	}
    ...
    public void init()
    {
       ...
       ballTex = Texture.loadTexture("ball.png");
        paddleTex = Texture.loadTexture("variable.png");
