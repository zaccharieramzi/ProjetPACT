...
public class FenetreAffichage {
	...
	// les deux lignes suivantes font parties de l'int�gration du syst�me permettant la reproduction d'une execution
...
//		buttonSecond.setPreferredSize(new Dimension(200, 100));
		...
		buttonSecond.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e){
				...
				ecran.setDeco(2);
				message=message+"Deco envoy�e: 2 \n";
				//ReproduireExec.ecrire(chemin, message);
		...
		buttonThird.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e){
				//manitou.setDeco(3);
				System.out.println("déco 3");
				ecran.setDeco(3);
				message=message+"Deco envoy�e: 3 \n";
				//ReproduireExec.ecrire(chemin, message);
...
//				ReproduireExec.ecrire(chemin, message);
		...
		buttonJouer.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				panneau.removeAll();
				try {
					System.out.println("le jeu va �tre lanc�");
					manitou.lancerJeu();
